...
class UnionMainBrookvillePlanScraper(BaseScraper):
    ...
    def fetch_plans(self) -> List[Dict]:
        try:
            ...
            print(f"[UnionMainBrookvillePlanScraper] Found {len(floor_plan_listings)} floor plan listings")
            ...
            for idx, listing in enumerate(floor_plan_listings):
                try:
                    ...
                    print(f"[UnionMainBrookvillePlanScraper] Floor Plan {idx+1}: {plan_data}")
                    listings.append(plan_data)
                    
                except Exception as e:
                    print(f"[UnionMainBrookvillePlanScraper] Error processing listing {idx+1}: {e}")
                    continue
